...
<html lang="en">
  <head>
    ...
    <title>Form-UNIB FAIR-LPTIK</title>
            ...
            <section id="contact">
                  <div id="form">
                    <form action="{{ route('buku_tamu_post') }}" id="contactForm" method="post">
                      ...
                      <input type="text" name="pekerjaan" required class="name" placeholder="Pekerjaaan" tabindex=1 />
                      ...
                      <input type="submit" name="submit" value="SIMPAN" class="submit" tabindex=5>
                    </form>
                  </div>
            </section>       
        </div>
